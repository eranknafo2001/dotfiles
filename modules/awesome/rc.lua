...
local browser1          = "@firefox@/bin/firefox"
local editor            = os.getenv("EDITOR")
local terminal          = "@kitty@/bin/kitty"
local filemanager       = "@nautilus@/bin/nautilus"
local editorgui         = "@kitty@/bin/kitty @nvim@/bin/nvim"
...
globalkeys = my_table.join(
    ...
    awful.key({ modkey }, "r",
    function ()
        awful.spawn(string.format("@rofi@/bin/rofi -no-config -no-lazy-grab -show drun -modi drun -theme ~/.config/awesome/rofi/launcher2.rasi",
    ...
    awful.key({ modkey1, altkey   }, "u", function() awful.util.spawn( "pavucontrol" ) end, -- TODO: ??????????
   ...
   -- awful.key({ modkey }, "Right", function () lain.util.tag_view_nonempty(1) end,
    ...
    awful.key({ }, "XF86MonBrightnessDown", function () os.execute("xbacklight -dec 10") end, -- TODO: is this work
              {description = "-10%", group = "hotkeys"}),

    -- ALSA volume control TODO: work?????
    ...
    awful.key({}, "XF86AudioStop", function() awful.util.spawn("@playerctl@/bin/playerctl stop", false) end)
