           ...
           layout =
             ...
             [
               ...
               (padding 6)
               {
                 ...
                 opts = {
                   keymap = [ "n" "f" (mkRaw "function() require('lz.n').trigger_load('fzf-lua'); smart_files() end") { noremap = true; silent = true; nowait = true; } ];
                   shortcut = "f";
               ...
               (padding 1)
               {
                 ...
                 opts = {
                   keymap = [ "n" "g" ":FzfLua live_grep <CR>" { noremap = true; silent = true; nowait = true; } ];
                   shortcut = "g";
               ...
               (padding 1)
               {
                 ...
                 opts = {
                   keymap = [ "n" "s" (mkRaw "require('persistence').load") { noremap = true; silent = true; nowait = true; } ];
                   shortcut = "s";
